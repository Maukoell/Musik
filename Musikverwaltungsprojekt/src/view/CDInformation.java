...
public class CDInformation extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CDInformation frame = new CDInformation();
	...
	public CDInformation() {
		...
		GridBagConstraints gbc_lblErscheinungsdatum = new GridBagConstraints();
		gbc_lblErscheinungsdatum.insets = new Insets(0, 0, 5, 5);
		gbc_lblErscheinungsdatum.gridx = 1;
		gbc_lblErscheinungsdatum.gridy = 0;
		panel_4.add(lblErscheinungsdatum, gbc_lblErscheinungsdatum);
		...
		gbc_lblVerlag.insets = new Insets(0, 0, 0, 5);
		gbc_lblVerlag.gridx = 1;
		gbc_lblVerlag.gridy = 4;
		panel_4.add(lblVerlag, gbc_lblVerlag);
